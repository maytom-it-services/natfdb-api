...
class DefaultCrudRepository {
    ...
    _createHasManyRepositoryFactoryFor(relationName, targetRepoGetter) {
        ...
        return relation_factory_1.createHasManyRepositoryFactory(meta, targetRepoGetter);
    }
    _createBelongsToAccessorFor(relationName, targetRepoGetter) {
        const meta = this.entityClass.definition.relations[relationName];
        return relation_factory_1.createBelongsToAccessor(meta, targetRepoGetter, this);
    }
